					...
					<div class="banner-box">
						...
						<div class="banner-images">
							<div class="all-img-banner">
								<img src="img/banner-bg-1.png" alt="banner" class="pizza-img">
			...
			<div class="banner-slide-2">
				<div class="container">
					<div class="banner-box">
						...
						<div class="banner-images">
							<div class="all-img-banner">
								<img src="img/pizza-banner-1.png" alt="banner" class="pizza-img">
			...
			<div class="banner-slide-3">
				<div class="container">
					<div class="banner-box">
						<div class="banner-images">
							<div class="all-img-banner">
								<img src="img/pizza-banner-2.png" alt="banner" class="pizza-img">
