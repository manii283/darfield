...
<body>
	...
	<section class="page-banner" style="background: #121619 url(img/a3.png) no-repeat center / cover;">
		<div class="container">
			<div class="row">
		...
		<div class="container">
			<div class="row flex-center">
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="about-img"><img src="img/chef-1(4).png" alt="about"></div>
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6">
					<div class="about-text">
						<div class="headding-part">
							<p class="headding-sub">Delicious Restaurant</p>
							<h2 class="headding-title text-uppercase font-weight-bold">about darfield pizza</h2>
						</div>
