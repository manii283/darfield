...
?>
	...
	<section class="page-banner" style="background: #121619 url(img/a15.png) no-repeat center / cover;">
		<div class="container">
			<div class="row">
		
				<div class="col-xl-12 col-lg-12 col-md-12">
					<div class="page-title">
						<h1 class="page-headding"><?php echo $category['name']?></h1>
						<ul>
							<li><a href="index.php" class="page-name">Home</a></li>
							<li><a href="shop-categories.php" class="page-name">Order Online</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-5 col-md-6 col-12">
					<div class="align-center mb-md-30">
					    <ul class="gc-start">
					        <li><img src=<?php echo $results['image']?> alt="pizzon" width="300px" height="400px" /></li>
					...
					<div class="shop-detail">
						<div class="shop-name">
							...
							<div class="price-shop">
								<span class="filter-price filter-price-r">$ 20.50</span>
						...
						<div class="quantity-product">
							...
							<input type="number" value="1" min="0" max="10" name="quantity">
	...
	<section class="releted-product special-menu pt-100 pb-100">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="img/menu-1 (8).jpg" alt="menu" class="menu-image"></a></div>
					<a href="shop-detail.php" class="menu-title text-uppercase">RUM WITH SODA</a>
					<p class="menu-des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
					<span class="menu-price">$20.50</span>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="img/menu-1 (2).jpg" alt="menu" class="menu-image"></a></div>
					<a href="shop-detail.php" class="menu-title text-uppercase">VEGETARIAN</a>
					<p class="menu-des">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
					<span class="menu-price">$20.50</span>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-4 text-center pt-20">
					<div class="menu-img"><a href="shop-detail.html"><img src="img/menu-1 (1).jpg" alt="menu" class="menu-image"></a></div>
